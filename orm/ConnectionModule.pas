...
type
  ...
  private
  public
    class function CreateManager: TObjectManager ;
...
class function TSQLiteConnection.CreateManager: TObjectManager;
begin
  Result := TObjectManager.Create(TSQLiteConnection.CreateConnection);
end;
